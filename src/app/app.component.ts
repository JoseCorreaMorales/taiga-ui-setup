...
import { tuiAsPortal, TuiRepeatTimes, TUI_IS_MOBILE } from '@taiga-ui/cdk';
import {
  TuiAppearance,
  TuiButton,
  TuiDataList,
...
@Component({
  ...
  template: `
    <div class="container">
      ...
      <div [style.display]="'flex'">
        ...
        <main tuiNavigationMain>
          ...
          <ng-container *tuiRepeatTimes="let index of 2">
            <form
    ...
    <div tuiDetailsStatus>
        ...
        <div tuiBlockDetails>
          <tui-avatar src="JW" [size]="isMobile ? 'xl' : 'xxl'" />
          <h2 tuiTitle>
            John W
            <div tuiSubtitle>money transfers</div>
          </h2>
          ...
          <div tuiDetailsStatus>
            <tui-icon icon="@tui.clock" [style.font-size.rem]="1" />
            Pending
          </div>
        </div>
      </div>
...
export class AppComponent {
  ...
  protected readonly routes1: any = 'test';
